...
\hypersetup{pdftitle={Submarine Geomorphology of the Deep-Sea Trenches in the Pacific Ocean: a Comparative Analysis of the Geospatial Data by Statistical Libraries of R and Python Programming Languages}, 
...
%\centering
\begin{titlepage}
	\title{\includegraphics[scale=0.65]{OUC-logo.png}\\Submarine Geomorphology of the Deep-Sea Trenches \\in the Pacific Ocean: a Comparative Analysis of the Spatial Data \\by Statistical Libraries of R and Python Programming Languages}
...
\chapter{Author's PhD curriculum}
	\markright{Author's PhD curriculum}\label{sec:9}
The author's educational activities of the PhD studies at \ac{OUC} (2016-2020) comprise 3 parts:\\
