...
%\centering
\begin{titlepage}
	\title{\includegraphics[scale=0.65]{OUC-logo.png}\\Submarine Geomorphology in the Pacific Ocean:\\ a Comparative Analysis of the Mariana and Philippine Trenches by Statistical Libraries of R and Python Programming Languages}
...
\begin{center}
\textbf{Submarine Geomorphology in the Pacific Ocean:\\ a Comparative Analysis of the Mariana and Philippine Trenches\\ by Statistical Libraries of R and Python Programming Languages}\\
\vspace{1em}
by Lemenkova Polina
\end{center}
...
\rfoot{\footnotesize{PhD Thesis by P. Lemenkova \\ \emph{'Submarine Geomorphology in the Pacific Ocean: a Comparative Analysis of the Mariana and Philippine Trenches\\ by Statistical Libraries of R and Python Programming Languages'}}}
...
\end{figure}
	...
	\section{Processing Oceanographic Data by Python Libraries NumPy, SciPy and Pandas}\label{sec:PyPan}
