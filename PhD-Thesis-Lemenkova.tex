...
\begin{map}[H]
	...
	\caption{Kuril-Kamchatka Trench and the Sea of Okhotsk: bathymetric map}\label{map:KKT1}
\end{map}
...
\begin{map}[H]
	...
	\caption{Kuril-Kamchatka Trench and the Sea of Okhotsk. Mercator oblique projection}\label{map:KKT9}
\end{map}
...
The formation of the hadal trench is affected by the impacts of local geological and geophysical settings varying along the trench.\\
 ...
 \begin{map}[H]
	...
	\caption{Kuril-Kamchatka Trench: contour bathymetric area. Conic projection.}\label{map:KKT10}
\end{map}
...
The tectonic properties of the study area mutually affect both land and submarine geomorphology. Thus, as noted by \cite{Pflanz}, the location of the  \ac{KKT} at the meeting place of active Kuril-Kamchatka \index[places]{Kuril-Kamchatka Arc} and Aleutian arcs \index[places]{Aleutian Arc} causes the coastline of the Kamchatka Peninsula \index[places]{Kamchatka Peninsula} to be affected by strong tectonic activities. Fracture zones\index[concepts]{fracture zones} have variable influence on the uplift of the Kamchatka Peninsula. The geomorphic consequence include raise of the multi- level, highly uplifted marine terraces\index[concepts]{marine terraces} displaced along the active tectonic faults. Furthermore, the tectonic movements cause the uplift of the coastal sediments \cite{Pflanz}. The \ac{KKT} belongs to the Chilean tectonic subduction type \index[places]{Chile}, which has a gentle subduction dip\index[concepts]{subduction dip} advancing at a speed of ca. 2 cm yr–1 and inter-seismic elastic shortening of 1–2 mm yr−1 \cite{DeMetsetal2010}. Strong lateral velocity in the shallower mantle wedge accounts for both the compressional subduction tectonics and back arc compression in the \ac{KKT}. This results in the seismic-velocity anomalies in the mantle under the \ac{KKT}, as shown on the tomographic images by \cite{Yoshida2017}. Despite the age of the Pacific Plate, there is no sharp variation of the age on the seafloor along the \ac{KKT} \cite{RenkinSclater}, and the old Pacific Plate \index[places]{Pacific Plate} is rejuvenated at the north of the \ac{KKT} around the Meiji Guyot seamount \index[places]{Meiji Guyot seamount}.
 ...
 \begin{map}[H]
	...
	\caption{Kuril-Kamchatka Trench: 3D-topographic mesh map.}\label{map:KKT11}
\end{map}
...
\begin{map}[H]
	\centering
		\includegraphics[width=10cm]{Fig-KKT12.jpg}
	\caption{Kuril-Kamchatka Trench: geoid modeled map}\label{map:KKT12}
\end{map}

 \begin{map}[H]
	\centering
		\includegraphics[width=10cm]{Fig-KKT13.jpg}
	\caption{Kuril-Kamchatka Trench: marine free-air gravity anomaly}\label{map:KKT13}
\end{map}
...
\begin{map}[H]
	\centering
		\includegraphics[width=10cm]{Fig-KKT14.jpg}
	\caption{Kuril-Kamchatka Trench: topographic surface modelling}\label{map:KKT14}
\end{map}
...
\begin{map}[H]
	\centering
		\includegraphics[width=10cm]{Fig-KKT15.jpg}
	\caption{Kuril-Kamchatka Trench: gravity surface modelling}\label{map:KKT15}
\end{map}
...
\begin{figure}[H]
	...
	\caption{Mariana Trench: histograms of data distribution by tectonic plates. Python}\label{fig:COMU-7}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Kermadec and Tonga trenches: geomorphological modelling}\label{fig:TK3}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Kermadec and Tonga trenches: models of slope gradient trends by profiles}\label{fig:TK4}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Kermadec and Tonga trenches: histograms of the bathymetric data distribution}\label{fig:TK5}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{New Britain and San Cristobal trenches: graph model of the cross-section profiles}\label{fig:TK5}
\end{figure}

\begin{figure}[H]
	\centering
		\includegraphics[width=13cm]{Fig-NBT8.jpg}
	\caption{New Britain Trench: modeled trends of the slopes gradient by profiles}\label{fig:TK5}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{San Cristobal Trench: modeled trends of the slopes gradient by profiles}\label{fig:TK5}
\end{figure}

\begin{map}[H]
	\centering
		\includegraphics[width=13cm]{Fig-NBT5.jpg}
	\caption{New Britain and San Cristobal trenches: segments of the digitized profiles}\label{map:TK5}
\end{map}
