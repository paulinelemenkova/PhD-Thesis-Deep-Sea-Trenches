...
(P. R. C.), Beijing, Grant \#2016SOA002, 2016-2020 for the total amount of 340,000 RMB. \\

Travel support of this study has been kindly provided by Peter Lemenkov: 9 full fare return air tickets Moscow-Beijing covering 4 semesters of my PhD studies at OUC, for the total amount of 134,303 CZK. \\

I thank Dr. Wang, Yonghong for the supervision of this thesis, general governance of the project, 
defining the scope of the research and our discussions on issues of the hadal trench geomorphology, their geological structure and formation, location and movements of the tectonic plates in the Pacific Ocean. \\

I thank Peter Lemenkov, Senior Software Engineer at Red Hat Czech s.r.o. Brno, Czech Republic, for the technical support in programming, our discussions on algorithms of data analysis, visualization and modelling, his assistance in optimizing syntax of Python coding, help in Unix utilities, AWK and R.
...
The bathymetric patters of the seafloor of the Pacific Ocean (\ref{fig:PO}) shows more complex and deep structure in its western part. The geologic structure of the Pacific Ocean has a complex character (Fig. \ref{fig:GeolW}). The global seafloor fabric, magnetic lineation picks, slab contours and tectonic plates boundaries are presented on Fig. \ref{fig:TectW}. 

\begin{figure}[H]
	\centering
	\includegraphics[width=14cm]{Fig-PO.jpg}
	\caption{The bathymetric raster map of the seafloor of the Pacific Ocean}\label{fig:PO}
\end{figure}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=12cm]{Fig-MAT1.jpg}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=12cm]{Fig-MAT2.jpg}
...
\begin{figure}[H]
	\centering
		\subfloat {\includegraphics[width=6.3cm]{Fig-M3.jpg}}
			\hspace{3mm}
		\subfloat {\includegraphics[width=7cm]{Fig-M4.jpg}}
			\hspace{3mm}
	\caption{Model of color geoid image (left) and gravimetry (right) of the Manila Trench}\label{fig:M3M4}
\end{figure}
...
\begin{figure}[H]
	\centering
		\subfloat {\includegraphics[width=6.7cm]{Fig-R3.jpg}}
			\hspace{3mm}
		\subfloat {\includegraphics[width=7cm]{Fig-R4.jpg}}
			\hspace{3mm}
	\caption{Model of color geoid image (left) and gravimetry (right) of the Ryukyu Trench area}\label{fig:R3R4}
\end{figure}
...
The geoid modelling of the Ryukyu Trench (Fig. \ref{fig:R3R4}) was done using following code:  gmt grdimage geoid.egm96.grd -I+a45+nt1 -R120/134/20/33 - JD127/24/27/30/6i -Cgeoid.cpt -P -K > \$ps Example of modelling geoid of \ac{MAT} area is on Fig. \ref{fig:MAT4}. The additional cartographic elements were added using GMT basemap module: grid, title, costline and GMT pscoast module. The full script is presented in Appendix \ref{GMT:04}.
...
\begin{figure}[H]
	...
	\caption{Median stacked profiles of the \ac{PCT} with error bars for the Chilean (A) and Perubian (B) segments}\label{fig:PCT6}
\end{figure}

\begin{figure}[H]
	\centering
		\includegraphics[width=10cm]{Fig-PCT5.jpg}
	\caption{Automatically digitized cross-section profiles of the \ac{PCT} for the Chilean (red) and Peruvian (yellow) segments.}\label{fig:PCT5}
\end{figure}

\begin{figure}[H]
	\centering
		\includegraphics[width=15cm]{Fig-PCT7.jpg}
	\caption{Histograms of the sample data distribution by the cross-section profiles, Peruvian and Chilean segments}\label{fig:PCT7}
\end{figure}
