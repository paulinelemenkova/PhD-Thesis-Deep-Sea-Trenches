...
There are 17 major trenches of the Pacific Ocean (Tab. \ref{tab:T1}). 
\pagebreak
...
\begin{figure}[H]
	...
	\caption{Mariana Trench. Mapping: \ac{GMT}}\label{fig:Bathy-MT}
\end{figure}
...
\vspace{0.8em}
\pgfornament[height=1cm,color=NavajoWhite1]{70}
\pgfornament[height=1cm,color=NavajoWhite1]{70}
\pgfornament[height=1cm,color=NavajoWhite1]{70}
\pgfornament[height=1cm,color=NavajoWhite1]{70}
\pgfornament[height=1cm,color=NavajoWhite1]{70}
...
%\hspace{9em}\pgfornament[width=10cm,color=Plum3]{88}
