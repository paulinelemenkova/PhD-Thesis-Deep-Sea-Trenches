...
\keywords{Pacific Ocean; geomorphology; bathymetry; Mariana Trench; Philippine Trench; Philippine Sea; Hikurangi Trench; Puysegur Trench; Hjort Trench; New Zealand; R; Python; Matplotlib; NumPy; SciPy; Pandas; Seaborn; geomorphic modelling, cartography, visualization, data analysis, programming language; statistics; spatial analysis; statistical analysis; cluster analysis; factor analysis; marine geology; geomorphology; bathymetry; algorithm; oceanography; GMT; GIS; QGIS, geoinformatics; GEBCO; ETOPO1; geodata; dataset;}
...
The geomorphology of the oceanic trenches has been mapped and visualized insufficiently detailed comparing to the terrestrial areas the Earth, due to the complex submarine relief and the technical difficulties of seabed observations. However, rapid development of new cartographic techniques, advanced methods of data modelling and visualization contributed to the progress in mapping and interpretation of the submarine geomorphology. Deep-sea trenches are mostly present a V- or U-shape in their cross-section profiles, yet can be more complex in form, e.g. trough-form, asymmetric, oblique, displaying riverine-like geometric system in a plain 2D (Figure \ref{map:PM12} and Figure \ref{map:PM14}), oblique or 3D view (Figure \ref{fig:PM13} and Figure \ref{fig:PM15}). Generally, the geomorphology of the hadal trenches vary in slope steepness, curvature and depths. 
...
\section{Summary}
The dissertation is focused upon comparative analysis of variability in geomorphological structure and formation of 20 deep-sea trenches. The work continues investigations of the geology of the Pacific Ocean and highlights interplay between geomorphic, geological, tectonic and volcanic factors affecting submarine landform formation. 
The aim of this work is to identify variations in the geomorphological structure of the 20 oceanic trench located in the Pacific Ocean, the deepest places of the Earth. 

Oceanic trenches present a complex ecosystem with highly interconnected factors: geology (sediment thickness and tectonics including tectonic plates), bathymetry (coordinates, slope angle, depth values in the observation points). To study such a complex system, an objective method combining various approaches was performed. This includes GMT high resolution mapping, statistical analysis by libraries of, R and Python, \ac{GIS} visualization, descriptive analysis and graphical plotting. 

Methodology of the research includes following clusters: R programming language for writing codes, statistical analysis, mathematical algorithms for data processing, analysis and visualizing diagrams, \ac{GIS} for digitizing bathymetric profiles and spatial analysis. The statistical analysis of the data taken from the bathymetric profiles was applied to environmental factors, i.e. coordinates, depths, geological properties sediment thickness, slope angles, etc. Additionally, factor analysis was performed by R libraries to analyze impact factors of the selected trench ( a case study of Mariana Trench). Euler-Venn logical diagrams highlighted similarities between four tectonic plates and environmental factors. The results revealed distinct correlations between the environmental factors (sediment thickness, slope steepness, depth values by observation points, geographic location of the profiles) affecting Mariana Trench morphology. The research demonstrated that coding on R language provides a powerful and highly effective statistical tools, mathematical algorithms of factor analysis to study ocean trench formation.
...
The bathymetric patters of the seafloor of the Pacific Ocean (\ref{map:PO}) shows more complex and deep structure in its western part. The geologic structure of the Pacific Ocean has a complex character (Fig. \ref{map:GeolW}). The global seafloor fabric, magnetic lineation picks, slab contours and tectonic plates boundaries are presented on Fig. \ref{map:TectW}. 
...
There are 20 deep-sea trenches of the Pacific Ocean (Tab. \ref{tab:T1}), including major and minor ones. 
...
The geographic object of this study is the Kuril-Kamchatka Trench\index[places]{Kuril-Kamchatka Trench}, an oceanic trench with depths more than 5000 m, located on the border of the Sea of Okhotsk located in the Far East, north-west Pacific Ocean (Fig. \ref{map:KKT1}). 
...
At the same time, there are local variations in northern and southern parts of the seafloor that influence the shape of the slopes. In the subduction zone of the Pacific Plate\index[places]{Pacific Plate}, these cross-sections of the tilted trench illustrate the crustal processes of the subduction and deposition of deep-sea sediments into the trench in its both segments. The sediment dispersal system of the trench forms two distinct types: the first one is a trench-parallel and a second one is a trench-crossing system. The geological parameters visualized on the Map \ref{map:KKT2} show fracture lines that predominantly have south-eastern direction showing perpendicular stretching towards the trench general direction. 
...
\begin{map}[H]
	\centering
		\includegraphics[width=10cm]{Fig-A4.jpg}
...
The work aims at understanding submarine geomorphology of the \ac{MAT}, Map \ref{map:MAT1}. The research methodology is based on the geospatial and statistical analysis using \ac{GMT} modules. The presented segment of the geological part of the research is focused on the Guatemala Trench, which is a southern part of \ac{MAT}, located on the Cocos Plate between the Tehuantepec Ridge\index[places]{Tehuantepec Ridge} and stretching until Cocos Ridge\index[places]{Cocos Ridge}, off Middle America\index[places]{Middle America } (Map \ref{map:MAT5}). 
...
Reaching maximal depth of 8,065 m, it is deepest trench of the South Pacific Ocean\index[places]{Pacific Ocean, South}. The Peru-Chile Trench is formed by the subduction of the Nazca\index[places]{Nazca Plate} and Antarctic plates\index[places]{Antarctic Plate} beneath the South American Plate\index[places]{South American Plate}. As followed by its name and location, the trench can be logically divided into two parts: Peruvian and Chilean ones. The Chilean part of the trench is longer than Peruvian, stretching in a NS direction along 4,300 km, from -18\degree\space S to -56\degree S. Due to the specific geologic, geotectonic, geomorphic and climatic characteristics, the region of the Peru-Chile Trench is exposed to a wide variety of hazardous processes such as earthquakes, local tsunamis, generated between the Peru-Chile Trench and the Chilean\index[places]{Chile} coasts, volcanism, as well as continent-specific geological hazards such as floods, landslides and mass movements, as briefly discussed below. The volcanism intensity in the study area can be illustrated by the recent documented tsunamigenic giant earthquakes: Valdivia\index[places]{Valdivia} earthquake, the largest ever recorded (Mw = 9.5), 1960 and the Maule\index[places]{Maule} earthquake (Mw = 8.8), 2010 \cite{Contrerasetal2010}. From the environmental aspect of view, the Peru-Chile is considered as eutrophic, that is having high biological productivity and organic matter on the seafloor of the trench \cite{Laceyetal2016}. \cite{Gambietal2003} illustrates the uniqueness of the biodiversity within the Peru-Chile Trench ecosystem as follows: high concentrations of the nutritionally-rich organic matter also at 7800-m depth, high nematode densities (>6000 ind. 10cm-2).

\subsection{Bathymetry}
	The bathymetry of the Peru-Chile trench has following distinguished features. The continental margin of Southern Chile between 36\degree\space S and 39\degree\space S has intermediate shelf of width 20-30 km \cite{Voelkeretal2008}. Here the gradient of the continental slope is inclined at 2.5\degree-4.0\degree with frequent irregularities: plateaus, slope basins and escarpments as steep as 10\degree. The South Chilean slope is dissected by four major and some minor meandering submarine canyons (Biobío\index[places]{Biobío Canyon}, Imperial\index[places]{Imperial Canyon}, Tolten\index[places]{Tolten Canyon} and Calle-Calle\index[places]{Calle-Calle Canyon}) connected to the large rivers flowing off the continent. 
...
The Biobío Canyon ends in submarine fans where it enter the trench \cite{ThornburgKulm}. Furthermore, the slightly sinuous axial channel is observed in the Chilean Trench, with a width of a 7-10 km and depth ca. 150 m \cite{Voelkeretal2008}. It originates from the Chacao Canyon at 41\degree S, is connected to the exits of the largest submarine canyon systems of the continental margin (Calle-Calle, Tolten, Biobío and San Antonio Canyons\index[places]{San Antonio Canyon}). 
...
Its closeness to the Antarctic makes it one of the coldest trenches in the world \cite{Belyaev}. Kermadec Trench runs parallel to the Kermadec Ridge\index[places]{Kermadec Ridge} (southern part of the Tonga-Kermadec Ridge\index[places]{Tonga-Kermadec Ridge}) with geomorphology of V- shape formed by tectonic subduction of the Pacific Plate under the Indo-Australian Plate\index[places]{Indo-Australian Plate} extending from approximately 26\degree-36\degree\space S near the northeastern tip of New Zealand's North Island\index[places]{North Island} \cite{LeducRowden2018}. The specific conditions of the tectonic setting in the study area is the subduction of the Pacific Plate at a rapid rate beneath the Indo-Australian Plate\index[places]{Indo-Australian Plate} along the Tonga-Kermadec Trench \cite{Castilloetal2009}, Map \ref{map:TK2}, right. 
...
The Vanuatu\index[places]{Vanuatu Trench}, a.k.a. New Hebrides Trench\index[places]{New Hebrides Trench} is located in Fiji Basin, East Australia, located in the area of the double convergent complex boundary where Pacific Plate subducts under the Indian-Australian plate westwards, and Indo-Australian plate beneath the North Fiji back-arc basin northeastwards. 
...
The New Britain Trench\index[places]{New Britain Trench} (a.k.a. Bougainville Trench\index[places]{Bougainville Trench}) is located eastwards off Papua New Guinea\index[places]{Papua New Guinea} as northern borders of the Solomon Sea\index[places]{Solomon Sea}, Pacific Ocean\index[places]{Pacific Ocean} (Map \ref{map:TK5}). The region is one of the world’s active subduction zones at the triple junction of the Pacific Plate, Indo-Australian Plate\index[places]{Indo-Australian Plate} and Solomon Sea Plate\index[places]{Solomon Sea Plate}. Additionally, the Woodlark Basin\index[places]{Woodlark Basin} subducts beneath the Solomon Islands arc\index[places]{Solomon Islands arc} region, forming a double-sided subduction zone \cite{Yoneshimaetal2005}. Because the region is situated within the complex zone of the convergence at the tectonic plates boundary, it is trapped between the converging Ontong Java Plateau\index[places]{Ontong Java Plateau} and Australian continent\index[places]{Australia}. Geologically, the study area belongs to one of the most prospective for intrusion-related mineral deposits \cite{Holmetal2019}.
...
The New Britain Trench is defined by the 6,000 m isoline. It is a narrow, 50-75 km wide trench extending northeasterly from the eastern end of the Huon Gulf\index[places]{Huon Gulf} along the south coast of New Britain\index[places]{New Britain Island} \cite{Mammerickx}. Its name is derived from the homonymous New Britain Island from the New Britain arc\index[places]{New Britain arc} (Map \ref{map:NBT1}). Its western extension are the north-dipping Ramu-Markham fault zone\index[places]{Ramu-Markham fault zone} and the West Bismarck arc\index[places]{West Bismarck arc} \cite{Abbott1994}. The northern part is characterized by the Bismark Sea\index[places]{Bismark Sea} back-arc basin (Fig. \ref{map:NBT2}) where active rifting and seafloor spreading take place. The Bismark Sea back-arc basin\index[places]{Bismark Sea back-arc basin} comprises the South\index[places]{South Bismarck Plate} and North Bismarck\index[places]{North Bismarck Plate} microplates separated by the Bismarck Sea fault\index[places]{Bismarck Sea fault} \cite{Taylor1979}. The islands of eastern Papua New Guinea\index[places]{Papua New Guinea} and the Solomon Islands\index[places]{Solomon Islands} are island arc terranes, surrounding New Britain Trench, are formed adjacent to the boundary between the Australia\index[places]{Australia Plate} and Pacific plates\index[places]{Pacific plate} \cite{Baldwinetal2012}.\\
As pointed by \cite{Lindley2006}, the subduction along the New Britain Trench is crucial for the tectonic development in Papua New Guinea\index[places]{Papua New Guinea} because comparing to other trenches of the Pacific Ocean, the New Britain Trench differs in its seismic structure below the trench. Thus, it indicates a steeply dipping ($>80\circ$) structure to upper mantle depths (630 km), unlike other Pacific trenches where dips range between 45\degree-60\degree. Further discussion on New Britain Trench tectonics and structure exist in further works (\cite{Weibenga1973}; \cite{Cooperetal1989}). The active volcanic arc that can be seen along the north coast of New Britain Island (Fig. \ref{map:NBT2}, red triangles) correlates with subduction curve along the New Britain Trench\index[places]{New Britain Trench}.
...
\begin{map}[H]
	\centering
 		\includegraphics[width=0.9\textwidth]{Fig-PM2.jpg}
...
\begin{map}[H]
	\centering
 		\includegraphics[width=1.0\textwidth]{Fig-PM7.jpg}
...
The topography of the 25 profiles (Fig. \ref{fig:GML2}) was plotted using ‘ProfileFromPoints’ plugin of \ac{QGIS} that enables to plot cross section profile of observation points. Using this plugin the topography data were plotted along a centerline of the cross section profiles using elevation Z (depth values). The resulting profiles are shown on Fig. \ref{map:GML1}.
...
\begin{map}[H]
	\centering
		\includegraphics[width=10cm]{Fig-R2.jpg}
...
\begin{map}
 	\includegraphics[width=1.0\textwidth]{Fig-PM15.jpg}
...
The sediment cover is less than 10 m thick and is composed of soft, bedded clay\index[concepts]{clay} with sand-size ash\index[concepts]{ash, sand-size} fragments. This clayey sediment covers a very gentle terrace\index[concepts]{terrace, submarine} 500 m wide \cite{CurtisMoyer2005}. The turbidite currents\index[concepts]{turbidite currents} are being generated on the outer shelf and upper continental slope\index[concepts]{continental slope}, due to the precipitation and transport via the submarine canyons\index[concepts]{submarine canyons} to the axial part of the trench. The speed of such sedimentation in the bottoms of trenches closely depends on the volumes of the incoming sediments\index[concepts]{sediments} ranging from 300 to 3000 mm/thousand years \cite{Ishizukaetal2018}. 
...
\begin{map}[H]
	\centering
 		\includegraphics[width=0.8\textwidth]{Fig-PM5.jpg}
...
\begin{map}[H]
	\centering
 		\includegraphics[width=0.6\textwidth]{Fig-PM8.jpg}
...
\begin{figure}[H]
	\centering
 		\includegraphics[width=0.8\textwidth]{Fig-PM9.jpg}
...
In turn, it might rise into the island-arc mantle\index[concepts]{mantle, island-arc} and the lower crust\index[concepts]{crust, lower}. This brief illustration of the deep correlation of the tectonic and geological processes that finally result in the actual land forms and geomorphological patterns. Seismic investigations of the Japan Trench axis furthermore shown \cite{Boseetal2015} variations in the frictional resistance along a decollement\index[concepts]{decollement} on the structural development of the frontal wedges near the subduction zones. The observed slope sediments between the inner and outer wedge might have accumulated during the growth of supercritical wedge. Seismic surveys indicate \cite{Kodairaetal2012} that the shallow areas at the site of the Tohoku earthquake\index[places]{Tohoku} experienced significant deformation. Moreover, during this event multiple faults slipped above and below the pelagic clay layer \cite{Rabinowitzetal2015}. The geophysical features of the Japan Trench area has beed discussed by \cite{Linetal2016} who compared Japan Trench Nankai subduction zone\index[places]{Nankai subduction zone} for the distribution of the stress state.
...
\subsection{Tectonic Settings}
Hjort Trench\index[places]{Hjort Trench} is characterized by an oblique subduction zone geoid anomaly. Large 1924 earthquake occurred in the northern Hjort Trench which suggest a thrust focal mechanism\index[concepts]{focal mechanism} and active subduction of young oceanic lithosphere beneath older oceanic lithosphere \cite{Cazenave1985}. Frequent seismic events, most less than 20 km deep, characterize the transpression\index[concepts]{transpression} along this plate boundary\index[concepts]{plate boundary} \cite{LodoloCoren}. The southern segment of the Alpine Fault\index[places]{Alpine Fault} on the South Island\index[places]{South Island} continues into the Tasman Sea Basin\index[places]{Tasman Sea} and finishes at the Puysegur Trench (Figure \ref{map:HPH5}). The oceanic Indo-Australian Plate\index[places]{Indo-Australian Plate} subducts eastwards through the Puysegur Trench\index[places]{Puysegur Trench} under the Pacific Plate\index[places]{Pacific Plate}. 

\subsection{Geologic Settings}
...
Mapping oceanic trench geomorphology data from the bathymetric maps should be based on the high resolution data to highlight isolines enabling to interpret steepness and gradient which requires certain cartographic interpretation. High-resolution bathymetric data is important  for mapping trench shape in a cross-section and to identify clearly its geomorphology. For these reasons, \ac{GEBCO} bathymetric grid was taken to map Figure \ref{FIG:1}. Pixel size at a course resolution bathymetric maps (e.g. ETOPO5) may reduce accuracy, therefore, ETOPO1 and \ac{GEBCO} datasets were chosen.
...
The \ac{GMT} modules ‘psconvert’, ‘psscale’ were used for visualizing scale bar on the maps, \ac{GMT} module ‘logo’ to add \ac{GMT} logo below the maps, ‘pstext’ \ac{GMT} module was used for adding annotations on the maps, ‘psxy’ module - for plotting geologic lineaments and sample points. The bathymetric data are presented as plan and oblique shaded-relief grids to highlight the major and distinct seafloor landforms of the \ac{MAT} (Figure \ref{map:MAT1}) which was mapped using the script provided in full in Appendix \ref{GMT:01}. 

Cartographic functionality of the GMT is assessed by technical visualization of the produced maps, models and graphs as well as tested variety of map projections. In this study, following various cartographic projections were used for plotting maps (examples for the Hikurangi and Puysegur trenches): Mercator (Figure \ref{FIG:1}, \ref{map:HPH4}, \ref{map:HPH5}, \ref{map:HPH6}, \ref{map:HPH7}, \ref{map:HPH10}, \ref{map:HPH11}), Mollweide pseudo-cylindrical homolographic equal-area, Eckert IV equal-area pseudo-cylindrical, Lambert Azimuthal Equal-Area (Figure \ref{map:HPH8}), Oblique Mercator (Figure \ref{map:HPH9}). 

\subsection{Seismic mapping} 

Focal mechanisms (Figure \ref{fig:PM3}) were drawn using 'psmeca' GMT module that reads dataset values from \ac{ASCII} file and generates a PostScript code plotting focal mechanisms. 
...
While magnitude is a widely understood concept, describing the energy of the earthquake release on a logarithmic scale, some technical details are presented in Table \ref{tab:11} and Table \ref{tab:12} used for mapping velocity (Figure \ref{map:PM4}), assigning and interpreting magnitudes. Introduced in the 1930's, the Richter Scale is the best known scale for measuring the magnitude of earthquakes  \cite{Muller2002}. Surface wave magnitude, creating the strongest disturbance within the upper layers of the Earth, is computed by the following algebraic Formula \ref{eq:8}:
...
Technically, the seismic moment tensor (Harvard \ac{CMT}, with zero trace) was plotted (Figure \ref{map:PM3}) by 'psmeca' module using the following GMT code snippet: \\
...
Earthquakes event map at \ac{PSB} area (Figure \ref{map:PM5}) shows prime hypocentres and magnitude values by color and size of the circles, respectively. The map was plotted on the basis of \ac{ISC}-EHB Bulletin and overplayed on the Google Earth map as a file in \ac{KMZ}, which is a file extension for a placemark file used by Google Earth. The geographic coordinates include x,y,z components in decimal degrees defined by the \ac{WGS84}. The overlay is visualized on Figure \ref{map:PM5}.
...
Technical visualization of the velocity map (Figure \ref{fig:PM4}) was performed using following \ac{GMT} code snippet: \\
\begin{itemize}
...
A geoid map (Figure \ref{map:PM6}) was visualized by the following GMT codes sequence:
...
For example, with a case of the Philippine Trench, the target area for the  was selected off Mindanao Island, the \nth{2} largest island in the Philippines, situated in the southern part of the archipelago. The \ac{AOI} square is 126.62\degree E 10.7\degree N 127.27\degree E 8.0\degree N. The \ac{AOI} for the Mariana Trench is located in the southwestern part of the crescent (Figure \ref{map:PM1}) and is bounded on the east by the Guam Island and on the south by the Yap Trench (Figure \ref{map:PM2}) encircled by the target square of 141.2\degree E 11.0\degree E 143.8\degree E 11.65\degree N, capturing the Challenger Basin. A sequence of the GMT codes was used for plotting transects as follows (example for the PT). A 'cat' Unix utility was used to plot target coordinates:
...
Using Python modules and libraries enables processing of the large oceanographic data more effective and significantly improves the computation algorithms. The general functioning of the Python followed the existing references and manuals, \cite{Oliphant2007}; \cite{Pedregosaetal2011}; \cite{PerezGranger2007}. Using libraries enable to create namespaces while working with modules. Python’s modules contain packed classes, objects, functions and constants used in the work. The installation of the libraries was done using pip upon the installing \ac{Python, NumPy}\index[concepts]{NumPy} and \ac{Python, SciPy}\index[concepts]{SciPy}, its dependancies: \\
...
The reason to choose the radar charts is that there are various statistical values that can be visualized by profiles, which requires a visualization technique for the facetted multi-plots (Figure \ref{fig:AR-5}). This graph shows series of the radar charts showing variation on the bathymetry by selected profiles.
...
\subsubsection{Variation in the distribution of the bathymetric data by stacked bar plots}
	Figure \ref{fig:AR-6} shows variation in the distribution of the bathymetric data by stacked bar plots for the Mariana Trench. 
...
\section{Middle America Trench}
The output model of the cross-section profiles is provided at Map \ref{map:MAT10} showing the initial bathymetric map (Map \ref{map:MAT10} B) and above a plotted series of the profiles (Map \ref{map:MAT10} A), such as oceanward backers of the trench and more steeper slope on the continental side. 
...
\pagebreak
\section{Philippine Trench}
The Philippine Trench (Figure \ref{map:PM12}) has a classic symmetric bell-shape form of histograms showing depth distribution with a notable sharp increase in data frequency at the interval of -5,000 to -6,000 m \ac{BSL} taking together 1,117 samples (22\% and 15\% of the data pool, i.e. 37\%). 
...
Comparing the Philippine and Mariana Trenches, seafloor bathymetry varies more notable westward of the trench axis by the Mariana Trench. The West Mariana Ridge (Figure \ref{map:PM14}) is located north off the trench axis at distance of 0-50 km, while northern part of Caroline Ridge is intersected by the southern transects of the trench profiles at a distance of about 180-200 km. A prominent trench-parallel belt of seamounts visualized on the 3D graph (Figure \ref{map:PM15}), appears at 148\degree-149\degree E. A group of seamounts eastwards off the Philippine Trench (Figure \ref{map:PM13}), stretching in a south-east direction with a narrow seamount bases and shallow apexes appears east off the archipelago at the trench axis at 130\degree E-135\degree E. However, at an area of the plate subduction 127\degree E-129\degree E, seamounts are absent and the seafloor has more unified pattern. Starting at 16\degree N-126\degree E, a ridge can be noted near the trench axis (Figure \ref{map:PM12}).

Marine free-air gravity anomaly in the \ac{PSB} is presented on Figure \ref{map:PM7}. Higher values ($>80$ mGal) of the gravity fields structure are apparent at volcanic areas and Philippine archipelago, as seen in orange to red colored areas on Figure \ref{map:PM7}. Anomalies $>60$ mGal are evident in the trench areas Figure \ref{map:PM7}, which are consistent with previous results (\cite{Yamazakietal2010}; \cite{Sandwelletal2014}; \cite{SmithSandwell1997a}). 
...
Automatic digitizing of the perpendicular transects cross-sectioning Mariana and Philippine trenches, respectively, demonstrated that Mariana trench’s geomorphology has steeper gradient slope on the northern (that is, left part of the graph on the Figure \ref{map:PM14}, below) flank on the archipelago's side (Figure \ref{fig:PM14}). More specifically, the slope steepness on the left flank of the selected segment of the trench has a 33,10\degree\space at 0-15 km from the center from the vertical plummet. A segment on 15-25 km has a steepness of 45\degree. A segment of 25-40 km has a steepness of 30,75\degree. Last segment (40-50 km before the shelf area) has a steepness of 28\degree. On the right flank of the trench its gradient steepness varies as follows. The segment at distance 0-28 km has a steepness of 40,5\degree\space from the vertical plummet. A segment of 28-37 km from the start point has a 43,33\degree\space of steepness. It then becomes gradually becomes gentles with 30,43\degree\space until the \nth{50} km. The segment at 50-90 km consists in the arc-shape gradual increase of the elevation which stabilizes after 100 km not exceeding -4000 \ac{BSL} (Figure \ref{map:PM14}). 

The results of the statistical data processing showing frequency data distribution are shown on Figure \ref{fig:PM16}. Data distribution for the Mariana Trench (Figure \ref{fig:PM16}, A) demonstrates bimodal peak of histograms for the depths from -5,000 m to -3,000 m with samples observations not exceeding 10\% for the selection. In this interval, the \nth{1} peak is covering -4,500 to -5,000 m \ac{BSL} and the \nth{2} one is for the -3,800 to -3,000 m. A gradual decrease in data samples below 5,000 m indicate a uniform way of data distribution for the depths range of -5,000 to -6,500 total frequency from 4\% to 2\% with 285 samples. 
...
On the contrary, the maximal depths reach up to -10,000 in the current dataset, as can be drawn from the Figure 11: profiles 20, 21, 22 crossing mostly Philippine tectonic plate (Figure 11). Another significant change is the decrease of depth in profiles 23, 24, 25, crossing Caroline tectonic plate, which may explain, among other factors the depth changes. Profiles Nr. 23 and 24 demonstrate the deepest depth data range. The created profiles are visualized on Figure \ref{fig:3-1-2}. Conversely, bathymetric profiles from 1 to 16 have gradual decrease in absolute depths (Figure 9), which can be noted in outliers sample location. A slight increase in absolute depths of the profiles nr. 4-8 was also observed of the Figure 8.
...
The southern part of the trench shows more gentle slope on the Honshu Island. The location of the swath profiles traversing the two segment of the Japan Trench South-West to North-East direction is shown in Figure \ref{map:JT7}. 12 profiles were drawn for the southern segment and 14 profiles for the northern one. The highly rugged geomorphological structure of the median profiles, as well as altitude increase in the S-N direction can be seen on the northern part of the trench (Figure \ref{map:JT10}). Furthermore, the results were interpreted based on the hypothesis that geological settings and seismicity of the area impact the trench roughness and general geomorphic shape when studying bathymetric patterns and variations by the cross- sectioning profiles of such complex targets as hadal trenches, which is shown on the geological map (Figure \ref{map:JT3}) with high level of the seismicity, repetitive earthquakes and volcanism along the path of the trench. Consequently, the western part of the trench profiles (Honshu Island slope) has steeper slopes comparing to the oceanward slopes for both segments, which can also be seen on the 3D model shown on Figure \ref{map:JT6}. 
...
In total, 139 samples (8+29+42+59) are located on the depths from -7000 to -8000 m in the southern part of the trench (Figure \ref{fig:JT9} B, left part of the graph). In the northern part of the trench, the same depth range has 124 records (12, 59 and 53 in the deepest part of the profile, Figure \ref{fig:JT9} A, left part of the graph). Furthermore, the values located on the depths from -4000 to -5000 meter are more frequent for the southern part of the trench: 134 records in total (35+33+37+29 samples, Figure \ref{fig:JT9}, B), while northern part of the trench do not overstep 100: 91 records (21+23+21+26 records, Figure \ref{fig:JT9}, A). To sum up, the southern part is shallower than northern part of the trench. It shows (Figure \ref{fig:JT11}) more deep values and the most frequent value is deeper that by the northern segment (Figure \ref{fig:JT10}).
...
The geophysical investigation of the presented modeling of geoid (a mean sea level model) and free-air gravity anomalies reflect the density variations of the Earth in the area across the Japan Trench and surroundings (Figure \ref{map:JT4} and Figure \ref{map:JT5}). The recorded area of the Japan Trench has geoid values of 0-20 mGal (Figure \ref{map:JT4}) as can be clearly seen as a light green color with dense isolines. The highest values on the geoid elevations is recorded by the Honshu Island (above 40 mGal, shown as red color on the map). The rest of the area is covered by the values in the range of 20-40 mGal, which shows moderate geoid undulations. The gravity map (Figure \ref{map:JT5}) shows density variations of the Earth’s interior in the study area. The free-air model shows gravity reduction from the topographic surface to the geoid in the study area. Map of free-air gravity anomalies (Figure \ref{map:JT5}) is defined with respect to the elevation showing values below -30 mGal in the Japan Trench area (visualized by deep purple color on the map). The marine areas of the Sea of Japan and the Pacific Ocean have values of up to 40 mGal of elevations. 
...
Puysegur Trench (Figure \ref{fig:HPH12}, B: middle plot) has an asymmetric V-form with steep gradient on the eastern slopes and more gentle slope on the west. Hjort Trench has a classic symmetric shape form with comparative gradients on both western and eastern slopes (Figure \ref{fig:HPH12}, C, lower plot). The results of the comparison of the median values (red line on Figure \ref{fig:HPH12} for all the three sub-plots) of three trenches show that selected segment of the Hikurangi Trench has shallower depths with maximal not exceeding - 2,500 m (Figure \ref{fig:HPH12}, A), while Puysegur Trench is reaching up to -6,000 m (Figure \ref{fig:HPH12}, B). 
...
The deepest values >6,000 m for Hjort Trench (Figure \ref{fig:HPH12}, C). The surrounding relief of the Hjort Trench presents the most uneven terrain comparing to the other trenches. The neighboring terrain has a gentle slope on the oceanward side for Hikurangi Trench, and a steep slope on the eastern flank for Puysegur Trench, which is surrounded by more complex submarine relief along the Macquarie Arc  (Figure \ref{map:HPH5}).

Puysegur Trench (Figure \ref{fig:HPH13}, A) has a bimodal type of data distribution with two peaks. The first peak has three notable bins range -4,200 to -4,400 m (373 samples detected, data frequency 18\%), range -4,000 to -4,200 (182 samples, data frequency 9,6\%) and -4,400 m to -4,600 m (216 samples, data frequency 11,5\%). The second peak covers depths from -2,200 to -3,000 m with the data frequency below 7,5\%. The peak corresponds to the Macquarie Arc bordering the trench slope. Data distribution for the Hjort Trench (Figure \ref{fig:HPH13}, C) has a classic bell-shape form with a clear peak of data at depths -3,200 to -3,400 m. (364 samples, 30\% of data frequency). The abrupt decrease in sample values off both flanks of the trench corresponds to the steep slope of the trench west off Hjort Plateu. 

Spreading fabrics can be seen (Figure \ref{map:HPH8}) eastwards off the Puysegur Trench, together with minor ridges. This geomorphology is particularly well expressed along Macquarie Arc, between 51,5\degree \space and 54\degree\space where ridges might form due to the sedimentation processes. The ridges resembling elongated seamounts can be seen on the north-west side off the Puysegur Trench (Figure \ref{map:HPH8}) interspersed with minor troughs. 
...
Data distribution for Hikurangi Trench (Figure \ref{map:HPH10}, B), the bathymetry has more equalized patterns at the depths -2,500 to -600 m. Notable peak have data located on the shallow areas (shallower than -500 m) where maximal values are detected for the range -400 to -300 m (258 samples).
