...
\chapter*{List of Tools}
	...
	\textbf{Main Tools}:
		\begin{itemize}
			...
			\item \href{https://www.python.org/}{Python}: Programming and statistical analysis
...
Figure 1. Study area: Mariana Trench. Submarine geomorphology features.
...
\subsection{Python code for joint Hexagonal and \ac{KDE} plots}\label{P:09}
\begin{python}
import seaborn as sb
from matplotlib import pyplot as plt
import pandas as pd
