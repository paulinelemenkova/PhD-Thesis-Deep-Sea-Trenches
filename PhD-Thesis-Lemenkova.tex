...
\begin{table}\caption{Summary of the statistics on the 17 deep-sea trenches of the Pacific Ocean}\label{tab:T1}
...
\begin{map}[H]
	...
	\caption{New Britain and San Cristobal trenches: topographic map}\label{map:TK5}
\end{map}

\begin{map}[H]
	\centering
		\includegraphics[width=13cm]{Fig-NBT3.jpg}
	\caption{New Britain and San Cristobal trenches: geoid model map}\label{map:TK5}
\end{map}
...
\begin{map}[H]
	\centering
		\includegraphics[width=13cm]{Fig-NBT2.jpg}
	\caption{New Britain and San Cristobal trenches: geological and tectonic map}\label{map:TK5}
\end{map}

\begin{map}[H]
	\centering
		\includegraphics[width=13cm]{Fig-NBT4.jpg}
	\caption{New Britain and San Cristobal trenches: gravimetry model map}\label{map:TK5}
\end{map}
...
\begin{map}[H]
	\centering
		\includegraphics[width=10cm]{Fig-M1.jpg}
...
\begin{map}[H]
	\centering
		\includegraphics[width=10cm]{Fig-R1.jpg}
...
The geological settings of the Palau Trench area is shown on Map \ref{map:YPT2}.
...
Besides, the \ac{GMT} scripting approach enables repeatability of the techniques for each of the studied 17 trenches of the Pacific Ocean. \\
