...
The table below (Tab. \ref{tab:T5}) presents a summary of the approaches of the descriptive statistical analysis used in current research for the profiles.

\begin{table}\caption{Algorithms of the descriptive statistical analysis}\label{tab:T5}
...
The summary of the used utilities and software is presented in Tab. \ref{tab:T4}.

\begin{table}\caption{Software and tools used in current research}\label{tab:T4}
...
This function provides a solution using a hybrid approach by combining the hierarchical clustering and the k-means methods. The workflow procedure include following steps: Tab. \ref{tab:T5}.

\begin{table}
\caption{Statistical algorithm of clustering, R}\label{tab:T5}
